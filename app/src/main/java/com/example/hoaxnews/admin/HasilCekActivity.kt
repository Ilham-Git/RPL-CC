...
class HasilCekActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val recyclerView = findViewById<RecyclerView>(R.id.rvCek)
        ...
        adapter.setOnItemClickListener(object : CustomAdapter.onItemClickListener{
            override fun onItemClick(position: Int) {
                Toast.makeText(this@HasilCekActivity, "Anda mengklik item nomer ${position+1}", Toast.LENGTH_SHORT).show()
                ...
                val intent = Intent(this@HasilCekActivity, DetailLaporanActivity::class.java)
